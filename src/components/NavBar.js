...
function NavBar() {
  return (
    <>
      <nav className="w-[560px] h-28 bg-black rounded-2xl z-10 fixed left-[30%] flex flex-row bottom-1 justify-center max-md:left-1 max-md:w-[500px] backdrop-blur-sm">
        <Link
          to="/"
